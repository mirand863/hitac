...
setwd("/run/media/fabio/9a846308-6659-4a3e-b18f-58210fc0f88a1/hitac/benchmark")

data <- read.csv("results/images/ocr_ucr_90_g.csv", header=T, sep=",")
...
plot <- ggplot(data, aes(x = UCR, y = OCR, group = Method, size = 9)) +
  ...
  guides(fill = "none") +
  ggtitle("Under-classification vs. over-classification rates", subtitle = "SP RDP ITS 90 at genus level") +
